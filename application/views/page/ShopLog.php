     ...
     <?php echo $sidebar; ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
			   ...
			   <?php foreach($data->result() as $loop):?>
                   ...
                   <a href="<?php echo base_url() . 'index.php/LogHome/showDetails/' . $loop->id_barang?>">
                   ...
                   <div class="text"><!-- text Begin -->
                       ...
                       <p class="button">
                           ...
                           <a href="<?php echo base_url() . 'index.php/LogHome/showDetails/' . $loop->id_barang?>" class="btn btn-default">View Details</a>
